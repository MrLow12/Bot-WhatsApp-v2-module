...
auth: state,
browser: ['Chrome (Linux)', 'zakkiXD', '']
});

if(usePairingCode && !haikal.authState.creds.registered) {
const phoneNumber = await question(color('\n\n\nSilahkan Masukan 62 di terminal cli:\n', 'magenta'));
...
require("./zakkixd")(haikal, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Creator : https://wa.me/6282137435046`})
...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await haikal.getName(i + '@s.whatsapp.net')}\nFN:${await haikal.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:zakkixploit@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/zkki_r12?igshid=OGQ5ZDc2ODk2ZA==\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`})}
//=================================================//
...
fs.watchFile(file, () => {
fs.unwatchFile(file)
console.log(chalk.redBright(`Update file terbaru${__filename}`))
